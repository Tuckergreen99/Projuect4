...
function setContinueResponse() {
    if (continueResponse === 1 || continueResponse === 0) {
        continueResponse = Number(PROMPT.question(`Do you want to continue rating movies? [0=no, 1=yes]:`));
...
function bubbleSort() {
    ...
    console.log('In order from Greatest to least: '+ratings[1] +', '+ ratings[2] +', '+ ratings[3] + `.`);}
